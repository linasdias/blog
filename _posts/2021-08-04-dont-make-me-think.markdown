---
layout: post
title:  "i just read 'don't make me think' by steve krug and here are my highlights"
date: 2021-08-04 14:30:00 +0800
...
- "your goal should be for each page or screen to be self-evident, so that just by looking at it the average user will know what it is and how to use it. in other words, they'll 'get it' without having to think about it. here's the rule: if you can't make something self-evident, you at least need to make it self-explanatory."

- "why us all of this so important? it's true that there's a lot of competition out there. but it'd not always true that people are fickle: they may have no choice but to stick with it; you'd be surprised at how long some people will tough it out on sites that frustrate them, often blaming themselves and not the site; besides, who's to say that the competition will be any less frustrating?"

- "making every page or screen self-evident is like having a good lighting in a store: it just makes everything seem better."

- "when we're creating sites, we act as though people are going to pore over each page, reading all of our carefully crafted text, et cetera, and what they actually do most of the time (if we're lucky) is glance at each new page, scan some text, and click on the first link that catches their interest."

- "why do we scan: (1) we're usually on a mission; (2) we know we don't need to read everything; (3) we're good at it."

- "when we're designing pages, we tend to assume that users will scan the page, consider all the available options, and choose the best one. in reality, though, most of the time we don't choose the best option -- we choose the first reasonable option, a strategy known as satisficing. as soon as we find a link that seems like it might lead to what we're looking for, there's a very good chance that we'll click it."

- "so why don't Web users look for the best choice? (1) we're usually in a hurry; (2) there's not much of a penalty for guessing wrong; (3) weighing options may not improve our chances; (4) guessing is more fun."

- "we don't figure out how things work, we muddle through: why does this happen? (1) it's not important to us; (2) if we find something that works, we stick to it."

- "if users 'get it': (1) there's a much better chance that they'll find what they're looking for, which is good for them and for you; (2) there's a better chance that they'll understand the full range of what your site has to offer -- not just the parts that they stumble across; (3) you have a better chance of steering them to the parts of your site that you want them to see; (4) they'll feel smarter and more in control when they're using your site, which will bring them back."
